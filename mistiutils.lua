...
function mistiutils.killable(self, area)
	...
	for i = 1, #area.cards do
		...
		if j ~= self and not j.ability["eternal"] and not j.getting_sliced then                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              end if j ~= self and not j.ability["eternal"] and not j.getting_sliced and pseudorandom("devilish_prank") < 0.95 then
			table.insert(t, j)
		end
	end
	return t
